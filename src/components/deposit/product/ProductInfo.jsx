      ...
      <div className='flex justify-between px-4 mx-auto max-w-screen-xl '>
        <article className='mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue'>
          <header className='mb-4 lg:mb-6 not-format'>
            ...
            <p class="text-gray-500 mb-4">공시 시작일 : {productOverallData.baseList__dcls_strt_day.substr(0, 4) + '년 ' + productOverallData.baseList__dcls_strt_day.substr(4, 2) + '월 ' + productOverallData.baseList__dcls_strt_day.substr(6, 2)+ '일'}</p>
                                ...
                                <div className="bg-white p-5">
                                    <div className="flex items-center justify-center">
                                        <div className=" sm:mt-0 sm:ml-2 text-center ">
                                            <h3 className="text-sm leading-6 font-medium text-gray-400">{item.optionList__save_trm}개월</h3>
            ...
            <section className='mb-4'>
              ...
              <div>
                ...
                {
                  productOverallData.baseList__join_way.split(",").map((item)=>{
                    return <span id="badge-dismiss-dark" className="inline-flex items-center px-2 py-1 mr-2 text-sm font-extrabold text-gray-800 bg-gray-100 rounded dark:bg-gray-700">
                    {item}
                  </span>
                  })
                }

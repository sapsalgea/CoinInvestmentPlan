                    ...
                    >
                      ...
                      <div className='w-full p-8 pb-12 flex items-center justify-between '>
                        ...
                        <div className='flex flex-col w-24 sm:w-32'>
                            <p className= {`text-center px-2 text-xs rounded-full sm:px-4 py-0.5 sm:py-1 ${(savingsData.optionList__intr_rate_type_nm === "복리")? 'text-blue-900 bg-blue-100' : 'text-red-900 bg-red-100'}`} >

                                            ...
                                            <div className="bg-white p-5">
                                                <div className="flex items-center justify-center">
                                                    <div className=" sm:mt-0 sm:ml-2 text-center ">
                                                        ...
                                                        <span className="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">{item.optionList__rsrv_type_nm}</span>
                                            ...
                                            <div className="bg-white p-5">
                                                <div className="flex items-center justify-center">
                                                    <div className=" sm:mt-0 sm:ml-2 text-center ">
                                                        ...
                                                        <span className="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">{item.optionList__rsrv_type_nm}</span>
